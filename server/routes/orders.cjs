...
router.post('/', async (req, res) => {
    try {
        ...
        // Gelen veriyi loglayarak kontrol et
        console.log('--- Gelen Sipariş Verisi ---');
        console.log('Req Body:', req.body);
        console.log('User:', user);
        console.log('productId:', productId);
        console.log('------------------------------');

        // Zorunlu alanların eksik olup olmadığını kontrol et
        if (!user || !user.walletAddress || !productId || !transactionSignature || !amount) {
            console.error('Hata: Eksik alanlar mevcut.');
        ...
        if (productError || !product) {
            console.error('Hata: Ürün bulunamadı. Product ID:', productId);
        ...
        if (existingOrder) {
            console.warn('Uyarı: İşlem zaten işlenmiş.');
        ...
        console.error('Son Hata Yakalama:', error.message);
